...
- Phase 4は在庫参照、出荷transaction、期間集計、ダッシュボードを追加する。
- Phase 5は製品CSVを同期検証し、全件成功または製品登録0件のJob結果を保存する。
- Phase 6は新しい業務領域を追加せず、製造指示の下書き編集・詳細、5マスタ管理、共通ページング、冪等demo seed、要件トレーサビリティを補完する。
